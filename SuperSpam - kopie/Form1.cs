...
namespace SuperSpam
{
            ...
            /*if (e.Button == MouseButtons.Left)
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            toolStripStatusLabel2.Text = "" + textBox1.GetLineFromCharIndex(i);
        ...
        private void themasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            SuperSpam_Theme theme = new SuperSpam_Theme();
            theme.Show();
            // ThemePanel.Show();
        }
